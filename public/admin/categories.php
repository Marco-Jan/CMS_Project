...
<main class="container mx-auto flex justify-center flex-col items-center">
    <header class="p-10">
        ...
        <button class="text-white bg-blue-500 p-4 rounded hover:bg-pink-600"><a href="category.php">Add a new
                category</a></button>
    </header>
            ...
            <?php foreach ($categories as $category): ?>
                <tr class="bg-white border-b dark:bg-gray-800">
                    ...
                    <td class="px-6 py-4 font-medium text-pink-600 whitespace-nowrap"><a
                            href="category.php?id=<?= $category['id'] ?>">Edit</a></td>
                    <td class="px-6 py-4 font-medium text-blue-600 whitespace-nowrap"><a
                            href="category-delete.php?id=<?= $category['id'] ?>">Delete</a></td>
                </tr>
            <?php endforeach; ?>
        </tbody>
    </table>
